    ...
    <div class="col-sm-12">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <label>Transaction No: </label>{{$bill->transaction_no}}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label>Reference No: </label> 
                    ...
                    {{$bill->logs->reference_no}}
                    @endif
            </div>
            <div class="form-group">
                <label>Vendor</label>{{$bill->vendor->name}}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label>Bill Date: </label>{{$bill->bill_date->toDateString()}}
            </div>
            <div class="form-group">
                <label>Due Date</label>{{$bill->due_date->toDateString()}}
            </div>
        </div>
