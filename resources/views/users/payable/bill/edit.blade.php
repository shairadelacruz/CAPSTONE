                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <option value="{{$bill->reference_no}}" selected="true">{{$bill->logs->reference_no}}</option>
                                @else
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="table-grandTotal">
                                        <input class="table-control right-align-text grandTotal" name="grandTotal" type="number" step="0.01" readonly="true" value="{{$bill->amount}}">
...
$('tbody').delegate('.productname','change',function(){
    ...
    var bill_id = $('.billHidden').val();
    var dataId = {'id':id};
    $.ajax({
        type    : 'get',
        url     : '/user/'+client_id+'/payable/bill/'+bill_id+'/edit/findPrice/'+id,
        dataType: 'json',
        data    : {'id':id},
